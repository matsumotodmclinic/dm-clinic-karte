...
// 色は持たせない（ここはカルテ文の組み立てを担うロジックで、見た目は UI 側の関心事）。
// 表示色は components/DmDxNoteEditor.js が key から決める。
export const DM_DX_DECISIONS = [
  { key: 'diagnosed', label: '糖尿病と診断',        note: 'GAD・CPRを追加' },
  { key: 'deferred',  label: '診断は見送り',        note: 'GAD・CPRを削除' },
  { key: 'known',     label: '過去に糖尿病の診断歴', note: 'GAD・CPRを追加' },
]
