...
${hasDm ?`- 【DM差分情報】が下に提供されている: ＃糖尿病（採血で判明）を ＃SAS の直下（HT/HLよりも前）に追加し、必要なら発症時期も記載。【糖尿病の症状】セクションも【SASの症状】の下に追加（チェックがある場合のみ）。重要既往（胃癌・膵癌・IHD・脳梗塞）があれば♯行で記載。家族歴のDM/HLにも反映。
