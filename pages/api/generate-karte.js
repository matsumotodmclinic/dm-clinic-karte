...
【仕事】${thyJobText}` : ''}
---------------------------------------------
甲状腺エコー：${tType === 'basedow-new' ? '' : useCheckboxEcho ? (thyEchoItems.length > 0 ? thyEchoItems.join('、') : '本日施行') : (d.echo?.thyroidEchoFindings || '本日施行')}${isNodule && d.echo?.noduleSize ? `　結節：${d.echo.noduleSize}` : ''}
---------------------------------------------
