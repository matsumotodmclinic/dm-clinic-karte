      ...
      case 1: return (
        <div>
          <div style={sBox({background:"#f5f0ff",border:"1.5px dashed #c8c0ee",marginBottom:14})}>
            <div style={{fontSize:13,fontWeight: 700,color:"#5a4fa8",marginBottom:4}}>💡 主病名の選択欄はありません</div>
...
<span style={{fontSize:12,background:TONE.bg,color:TONE.fg,padding:"4px 12px",borderRadius:4,fontWeight:700}}>内分泌</span>
          </div>
        </div>
