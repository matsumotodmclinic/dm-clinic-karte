...
- **音声入力が無ければ AI を 1 回も呼ばない**（決定論・即時・無料）。当院の運用では大半がこちら
- 音声があるときだけ **①受診理由サマリーの統合 ②♯既往のマージ** を AI に頼む
...
- **音声入力なしの状態で検査する**（音声があると統合プロンプトが何でも運んでしまい検査が緩くなる）
